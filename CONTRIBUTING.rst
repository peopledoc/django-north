...
Django North could always use more documentation, whether as part of the
official Django North docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7. Check
   https://travis-ci.org/peopledoc/django-north/pull_requests
